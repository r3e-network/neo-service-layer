...
{
    /// <summary>
    /// Exception thrown when a security violation occurs within the enclave.
    /// </summary>
    [Serializable]
    public class SecurityException : Exception
    {
        ...
        /// <summary>
        /// Gets or sets the security violation code.
        /// </summary>
        public int ViolationCode { get; set; }

        /// <summary>
        /// Gets or sets the security operation that was being performed when the exception occurred.
        /// </summary>
