...
public interface ICommandHandler&lt;in TCommand, TResult&gt; where TCommand : ICommand & lt; TResult & gt;
{
    /// <summary>
    ...
    Task & lt; TResult & gt; HandleAsync(TCommand command, CancellationToken cancellationToken = default);
}
}
