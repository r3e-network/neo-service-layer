...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "System monitoring and alerts")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class MonitoringContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "monitor:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "MonitoringContract deployed");
        }
