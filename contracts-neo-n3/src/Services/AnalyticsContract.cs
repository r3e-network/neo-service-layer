...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Analytics and metrics tracking")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class AnalyticsContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "analytics:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "AnalyticsContract deployed");
        }
