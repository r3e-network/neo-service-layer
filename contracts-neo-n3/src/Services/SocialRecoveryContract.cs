...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Social recovery for wallets")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class SocialRecoveryContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "recovery:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "SocialRecoveryContract deployed");
        }
