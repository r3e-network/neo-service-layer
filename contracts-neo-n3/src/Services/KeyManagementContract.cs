...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Cryptographic key management")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class KeyManagementContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "keys:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "KeyManagementContract deployed");
        }
