...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Payment processing service")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class PaymentProcessingContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "payment:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "PaymentProcessingContract deployed");
        }
