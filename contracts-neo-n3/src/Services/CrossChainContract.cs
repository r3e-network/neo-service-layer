...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Cross-chain interoperability")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class CrossChainContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "crosschain:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "CrossChainContract deployed");
        }
