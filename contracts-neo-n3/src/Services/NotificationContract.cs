...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Event notification service")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class NotificationContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "notify:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "NotificationContract deployed");
        }
