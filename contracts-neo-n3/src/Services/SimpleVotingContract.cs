...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Simple voting mechanism")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class SimpleVotingContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "vote:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "SimpleVotingContract deployed");
        }
