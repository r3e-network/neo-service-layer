...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "NFT and asset marketplace")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class MarketplaceContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "market:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "MarketplaceContract deployed");
        }
