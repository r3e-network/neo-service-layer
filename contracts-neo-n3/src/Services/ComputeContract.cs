...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Distributed computing services")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class ComputeContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "compute:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "ComputeContract deployed");
        }
