...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Compliance and regulatory checks")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class ComplianceContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "compliance:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "ComplianceContract deployed");
        }
