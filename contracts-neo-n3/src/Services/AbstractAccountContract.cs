...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Abstract account management")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class AbstractAccountContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "account:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "AbstractAccountContract deployed");
        }
