...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Digital identity management")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class IdentityManagementContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "identity:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "IdentityManagementContract deployed");
        }
