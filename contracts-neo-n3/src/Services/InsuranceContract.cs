...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Insurance policy management")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class InsuranceContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "insurance:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "InsuranceContract deployed");
        }
