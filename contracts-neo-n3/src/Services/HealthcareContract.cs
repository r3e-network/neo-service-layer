...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Healthcare data management")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class HealthcareContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "health:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "HealthcareContract deployed");
        }
