...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "Automated task execution")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class AutomationContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "automation:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "AutomationContract deployed");
        }
