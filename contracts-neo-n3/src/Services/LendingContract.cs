...
namespace NeoServiceLayer.Contracts.Services
{
    ...
    [ManifestExtra("Description", "DeFi lending services")]
    [ManifestExtra("Version", "1.0.0")]
    [ContractPermission("*", "*")]
    public class LendingContract : SmartContract
    {
        // Storage prefix for this contract
        private static readonly ByteString StoragePrefix = "lending:";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            Deployed(tx.Sender, "LendingContract deployed");
        }
