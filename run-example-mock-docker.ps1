# Run the example with mocked dependencies
Write-Host "Running Neo Service Layer example with mocked dependencies in Docker..." -ForegroundColor Green
...
docker-compose -f docker-compose.example-mock.yml up -d
...
Write-Host "Neo Service Layer example with mocked dependencies is running!" -ForegroundColor Green
